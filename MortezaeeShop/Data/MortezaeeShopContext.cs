...
namespace MortezaeeShop.Data
{
    public class MortezaeeShopContext : DbContext
    {
        public MortezaeeShopContext(DbContextOptions<MortezaeeShopContext> options) : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //    {
            //        p.HasKey(t => t.Id);
            //        p.OwnsOne<Item>(t => t.Item);
            //        p.HasOne<Item>(w => w.Item).WithOne(t => t.product)
            //        .HasForeignKey<Item>(t => t.Id);
            //    });
